...
local snowWorldWidth, snowWorldHeight = world.width * world.snowWidth, world.height * world.snowHeight
...
function world.draw(playerX, playerY)
	...
	starty = math.floor(player.y / (math.floor(world.tileHeight / 8))) - math.floor((love.graphics.getHeight() / (math.floor(world.tileHeight / 8) + 1)))
	endy = math.floor(player.y / (math.floor(world.tileHeight / 8) + 1)) + math.floor((love.graphics.getHeight() / (math.floor(world.tileHeight / 8) + 1))) + 2
